...
public class ErrorAmpT2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ComboLOUnit.setModel(new DefaultComboBoxModel(new ComboItem[] {new ComboItem("-","1"), new ComboItem("m","0.001"),new ComboItem("u","0.000001"),new ComboItem("n","0.000000001")}));
